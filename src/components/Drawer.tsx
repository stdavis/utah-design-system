...
const drawer = tv({
  slots: {
    ...
    triggerButton:
      'absolute z-10 flex justify-center overflow-hidden rounded border border-zinc-200 bg-white p-1 hover:border-zinc-300 hover:bg-slate-200 pressed:bg-slate-300 dark:hover:border-zinc-600 dark:hover:bg-white/10 dark:pressed:bg-slate-100',
  },
  variants: {
    type: {
      sidebar: {
